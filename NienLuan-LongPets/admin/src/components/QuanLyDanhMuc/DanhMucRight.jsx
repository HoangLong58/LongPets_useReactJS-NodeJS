...
const DanhMucRight = ({ reRenderData, setReRenderData }) => {
    ...
    useEffect(() => {
        const getSoLuongDanhMuc = async () => {
            try {
                const soluongdanhmucres = await axios.get("http://localhost:3001/api/products/getSoLuongDanhMuc");
            ...
            <SalesAnalytics>
                ...
                <Item className="online">
                    ...
                    <ItemRight>
                        ...
                        <h3 className="success" style={{ fontSize: "1.2rem" }}>{soLuongDanhMuc}</h3>
                    </ItemRight>
                </Item>
